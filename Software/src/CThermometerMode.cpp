...
namespace RGBLightControl {
  ...
  CThermometerMode::CThermometerMode(IThermometer* pThermometer)
    : m_pThermometer(pThermometer)
  {
  }
  ...
  CThermometerMode::~CThermometerMode()
  {
  }
  ...
  bool CThermometerMode::SetColors(const t_Configuration & oConfig)
  {
  ...
  t_Configuration CThermometerMode::GetColors() const
  {
  ...
  bool CThermometerMode::SetCallback(void* pObject,
